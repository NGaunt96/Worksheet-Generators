...
TITLE = "Orange Percentage Increase and Decrease"
questions = ["Increase", "Decrease"]

def NicePercInDe(numQ):
    documentQ = Document()
    ...
    while count != numQ:
        q = choice(questions)
        niceNumbers = [1, 2, 5, 10, 15, 20, 25, 30, 40, 50, 60, 70, 75, 80, 90, 95, 98, 99]
